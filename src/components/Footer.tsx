          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3 group">
              ...
              <div className="text-sm font-black group-hover:text-brand-gold transition-colors cursor-pointer space-y-1">
                <div>Trụ sở chính: Khu 6 Vó Lao, xã Đông Thành, tỉnh Phú Thọ.</div>
                <div>Cơ sở 2: Khu 4 Ninh Dân, xã Hoàng Cương;</div>
                <div>Cơ sở 3: Số 35 Hàn Thuyên, xã Thanh Ba, tỉnh Phú Thọ;</div>
                <div>Cơ sở 4: Khu 2 xã Đông Thành, tỉnh Phú Thọ.</div>
              </div>
            </li>
            <li className="flex items-start gap-3 group">
              <span className="text-brand-blue mt-1">📞</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 p-6 rounded-[2rem] space-y-4">
            <p className="text-xs text-slate-300 leading-relaxed">
              Open Minds English Centre được thành lập với sứ mệnh đồng hành cùng học sinh trên hành trình chinh phục tiếng Anh, mở rộng kiến thức và nuôi dưỡng những ước mơ, hoài bão cho tương lai.
            </p>
          </div>
        </div>
      </div>
